...
2. **QUA-8** (sortir du style inline) puis **UX-4** — QUA-3 a livré le harnais qui manquait pour
   convertir quinze composants sans régression muette, et QUA-5 le linter qui dira ce que le
   reformatage aura cassé.
